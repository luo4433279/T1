...
public class RoleController {
    ...
    @ResponseBody
    public String grantResources(@PathVariable("id") String id,@RequestParam(value="rid[]" ,required=false) String[] rid) {
        if(rid==null){
           rid=new String[0];
        }
    ...
    @ResponseBody
    public String grantMenu(@PathVariable("id") String id, @RequestParam(value="mid[]",required=false) String[] mid) {
        if(mid==null){
            mid=new String[0];
        }
